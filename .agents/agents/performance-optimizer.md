...
model: inherit
skills: clean-code, performance-profiling, supabase-postgres-best-practices, nextjs-react-expert, dotnet-best-practices, nodejs-best-practices, python-patterns, rust-pro, agentic-debugging
---

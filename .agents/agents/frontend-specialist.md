...
model: inherit
skills: clean-code, modern-react-nextjs, nextjs-react-expert, agentic-web-design, tailwind-patterns, frontend-design, lint-and-validate, i18n-localization, performance-profiling, seo-fundamentals, webapp-testing, powershell-windows, bash-linux
---

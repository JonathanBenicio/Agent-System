...
model: inherit
skills: clean-code, deployment-procedures, server-management, powershell-windows, bash-linux, performance-profiling, vulnerability-scanner, red-team-tactics, agentic-debugging, mcp-builder, code-review-checklist
---

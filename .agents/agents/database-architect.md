...
model: inherit
skills: clean-code, database-design, supabase-postgres-best-practices, performance-profiling, dotnet-best-practices, nodejs-best-practices, python-patterns, rust-pro, powershell-windows, bash-linux
---

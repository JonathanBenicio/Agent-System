...
model: inherit
skills: clean-code, app-builder, plan-writing, agentic-brainstorming, architecture, api-patterns, database-design, frontend-design, mobile-design, parallel-agents, behavioral-modes, intelligent-routing
---

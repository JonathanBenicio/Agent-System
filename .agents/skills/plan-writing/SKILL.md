...
### 4. Dynamic Naming in docs/plan/
- Plan files are saved as `{task-slug}.md` in the `docs/plan/` directory
- Name derived from task (e.g., "add auth" → `auth-feature.md` stored at `docs/plan/auth-feature.md`)

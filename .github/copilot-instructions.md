...
- Use [docs/architecture/backend-architecture-explained.md](../docs/architecture/backend-architecture-explained.md) as the source of truth for the current runtime topology.
...
- Keep future-capability planning aligned with [docs/planejamento/AI_Advanced_Capabilities_Roadmap.md](../docs/planejamento/AI_Advanced_Capabilities_Roadmap.md) and subsystem details in [docs/TECHNICAL_ARCHITECTURE_GUIDE.md](../docs/TECHNICAL_ARCHITECTURE_GUIDE.md).